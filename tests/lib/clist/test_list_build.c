...
Test(array_build, test_array_build)
{
    ...
    list = list_init();
    node_append(list, "DATA");
    node_append(list, "DATA2");
    node_append(list, "DATA3");
    node_append(list, "DATA4");
    array = (char **)array_build_from_list(list);
...
Test(array_build, test_array_build_null)
{
    ...
    array = (char **)array_build_from_list(NULL);
    cr_assert_null(array);
}
...
Test(list_build, test_list_build)
{
    ...
    array[3] = "DATA4";
    array[4] = NULL;
    list = list_build_from_array(array);
    cr_assert_eq(list->size, 4);
...
Test(list_build, test_list_build_null)
{
    ...
    list = list_build_from_array(NULL);
    cr_assert_null(list);
}
